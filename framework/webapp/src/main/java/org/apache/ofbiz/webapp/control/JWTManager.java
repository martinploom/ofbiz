...
public class JWTManager {
    ...
    public static String createJwt(Delegator delegator, Map<String, String> claims) {
        int expirationTime = Integer.parseInt(EntityUtilProperties.getPropertyValue("security", "security.jwt.token.expireTime", "18000",  delegator));
    ...
    public static String createJwt(Delegator delegator, Map<String, String> claims, String keySalt, int expireTime) {
        if (expireTime <= 0) {
            expireTime = Integer.parseInt(EntityUtilProperties.getPropertyValue("security", "security.jwt.token.expireTime", "18000",  delegator));
        }
